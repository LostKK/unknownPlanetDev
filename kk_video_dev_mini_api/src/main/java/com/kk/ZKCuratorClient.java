...
import com.kk.config.ResourceConfig;
...
public class ZKCuratorClient {
	...
	//public static final String ZOOKEEPRER_SERVER = "192.168.0.103:2181";
	...
	public void init() {
		...
		try {
			// String testNodeData = new
			// String(client.getData().forPath("/bgm/190103HWSYBZTNTC"));
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
				...
				if (event.getType().equals(PathChildrenCacheEvent.Type.CHILD_ADDED)) {
					...
					System.out.println("operType"+operatorType);
					System.out.println("songPath"+songPath);
//					String str[] = path.split("/");
//					String bgmId = str[str.length-1];
...
//					String songPath = bgm.getPath();
					...
					//2.定义保存到本地的bgm路径      本地！
					//String filePath = "D:\\my ware\\tiktok\\kk_video_dev" + songPath;
